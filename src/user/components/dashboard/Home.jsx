...
const Home = () => {
  ...
  useEffect(() => {
    const fetchWalletData = async () => {
      try {
        const response = await axios.get(`${ENDPOINTS.baseUrl}/getWallet`, {
          params: { 
            userId: user?._id,
    ...
    const fetchFundingHistory = async () => {
      try {
        const response = await axios.get(`${ENDPOINTS.baseUrl}/getTotalFunding`,{params: { userId: user._id } } );
    ...
    const fetchTopupData = async () => {
      try {
        const response = await axios.get(`${ENDPOINTS.baseUrl}/getTotalTopup`, {
